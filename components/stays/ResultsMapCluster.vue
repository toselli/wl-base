      ...
      import('leaflet')
        .then((leaflet) => {
          ...
          iconClusterBlue.value = new L.value.Icon({
            iconUrl: '/img/icons/blue-map-cluster-icon.png',
            iconSize: [30, 30],
            iconAnchor: [15, 15],
            popupAnchor: [1, -34],
            shadowSize: [41, 41]
          ...
          iconClusterYellow.value = new L.value.Icon({
            iconUrl: '/img/icons/darken-map-cluster-icon.png',
            iconSize: [35, 35],
            iconAnchor: [18, 18],
            popupAnchor: [1, -34],
            shadowSize: [41, 41]
          ...
          iconClusterRed.value = new L.value.Icon({
            iconUrl: '/img/icons/darker-map-cluster-icon.png',
            iconSize: [45, 45],
            iconAnchor: [22, 22],
            popupAnchor: [1, -34],
            shadowSize: [41, 41]
