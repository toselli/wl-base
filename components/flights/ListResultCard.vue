                        ...
                        <v-row align="center">
                            <v-col cols="12" class="body-1 d-flex justify-start align-baseline">
                                ...
                                <v-sheet class="border body-1 pa-2 ml-3" rounded="sm">
                                    ...
                                    <span class="body-2 text-secondary_text"> {{ dayjs('2024-01-01T' +
                                        group.TotalTime).format("H[hs], mm[min]") }}</span>
                            ...
                            <v-col cols="12">
                                <v-sheet class="bg-background py-4" rounded="md">
                                    <v-row no-gutters dense>
                                        <v-col cols="3" class="pl-3 ml-3 pb-3 text-left">
                                        ...
                                        <v-col cols="3">
                                            <v-sheet class="bg-transparent pa-3 d-flex flex-column align-items-center">
                                                ...
                                                <span class="body-2 text-secondary_text">{{
                                                    parseAirport(group.Segments[0].OriginAirport.Name).airportName }}</span>
                                            ...
                                            <v-sheet class="bg-transparent pa-3 d-flex flex-column align-items-center">
                                                ...
                                                <span class="body-2 text-secondary_text">{{
                                                    parseAirport(group.Segments[group.Segments.length -
                                                        1].DestinationAirport.Name).airportName }}</span>
                                                <h4 class="semi secondary_text">{{
                                                    parseAirport(group.Segments[group.Segments.length -
