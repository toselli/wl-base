    ...
    <div class="card-form">
              ...
              <div class="card-item__content">
                <label for="cardName" class="card-item__info" ref="cardName">
                  ...
                  <transition name="slide-fade-up">
                    ...
                    <div class="card-item__name" v-else key="2">NOMBRE EN LA TARJETA</div>
                  </transition>
                </label>
                <div class="card-item__date" ref="cardDate">
                  <label for="cardMonth" class="card-item__dateTitle">Hasta</label>
      ...
      <div class="card-form__inner">
        <div class="card-input">
          <label for="cardNumber" class="card-input__label">N° de la tarjeta</label>
          <input type="text" id="cardNumber" class="card-input__input" v-mask="generateCardNumberMask" :key="maskKey"
            v-model="cardNumber" @focus="focusInput" @blur="blurInput" data-ref="cardNumber"
            autocomplete="off" :maxlength="getCardType == 'amex' ? 17 : 19">
        </div>
        <div class="card-input">
        ...
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              ...
              <select class="card-input__input -select body-1" id="cardMonth" v-model="cardMonth" @focus="focusInput"
                @blur="blurInput" data-ref="cardDate">
                <option value="" disabled selected>Mes</option>
                <option :value="n < 10 ? '0' + n : n" v-for="n in 12" :disabled="n < minCardMonth" :key="n">
                  {{ n < 10 ? '0' + n : n }} </option>
              </select>
              <select class="card-input__input -select body-1" id="cardYear" v-model="cardYear" @focus="focusInput"
                @blur="blurInput" data-ref="cardDate">
        ...
        <v-btn flat color="primary" rounded="md" :disabled="!isFormValid" @click="confirmCardData">Confirmar datos</v-btn>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    isCardNumberValid() {
    const maskLength = this.generateCardNumberMask.length;
    return this.cardNumber.length == maskLength;
  },
  isCvvValid() {
    return this.cardCvv.length >= 3;
  },
  isFormValid() {
    return this.getCardType != 'default' && 
           this.cardName != '' && 
           this.cardMonth != '' && 
           this.cardYear != '' && 
