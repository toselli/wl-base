  ...
  <v-card rounded="lg" class="list-result-card fill-height" flat :id="item.Id">
    ...
    <v-row dense no-gutters :class="mode == 'list' ? '' : 'fill-height'">
      <v-col cols="12" :lg="mode == 'list' ? '3' : '12'" class="pa-0">
        <v-img :src="item.Transfer.VehicleInfo.UrlImage" height="164px" lazy-src="/img/services/no_results_cars.png" contain></v-img>
      </v-col>
    ...
    board.Amount.toFixed(2) }}</v-chip>
      ...
      <v-col cols="12" :lg="mode == 'list' ? '3' : '12'"
        class="pa-4 text-right d-flex justify-space-between flex-column">
