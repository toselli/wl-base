<template>
  <v-container class="content-container">
    ...
    <v-row dense class="mt-md-1">
      <v-col>
        <stays-search-card :compact="true" :noplaces="true" themed="none" />
      </v-col>
    </v-row>
            ...
            <v-window-item :value="index" v-for="room, index in rooms">
              <v-container v-if="avail">
                ...
                <v-row dense v-if="!loadingAvail && avail.length > 0">
                  ...
                  <v-col cols="12" v-if="avail.length > limitAvail">
                ...
                <v-row class="mt-3" justify="center" v-if="avail.length == 0 && !loadingAvail && !isReceiving">
                  <v-col cols="12" class="text-center">
                    <h3>En este momento no hay habitaciones disponibles</h3>
                    <v-img src="/img/services/no_avail.png" width="280" class="my-6 mx-auto"></v-img>
